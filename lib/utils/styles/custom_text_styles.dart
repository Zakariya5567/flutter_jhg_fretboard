...
class CustomTextStyles {
  ...
  static final redSmallTextStyle = TextStyle(
      color: AppColors.redColor,
      fontSize: Adaptive.sp(10.0),
      fontFamily: GoogleFonts.plusJakartaSans().fontFamily);

  static final redMediumTextStyle = TextStyle(
      color: AppColors.redColor,
      fontSize: Adaptive.sp(12.0),
      fontFamily: GoogleFonts.plusJakartaSans().fontFamily);

  static final red14MediumTextStyle = TextStyle(
      color: AppColors.redColor,
      fontSize: Adaptive.sp(14.0),
      fontFamily: GoogleFonts.plusJakartaSans().fontFamily);

  static final redLargeTextStyle = TextStyle(
      color: AppColors.redColor,
      fontSize: Adaptive.sp(16.0),
      fontFamily: GoogleFonts.plusJakartaSans().fontFamily);

  static final redExtraLargeTextStyle = TextStyle(
      color: AppColors.redColor,
  ...
  static final goldNormalTextStyle = TextStyle(
      color: Color(0XFFF8A44B),
