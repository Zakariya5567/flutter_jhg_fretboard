...
class _SettingScreenState extends State<SettingScreen>{
      ...
      body:  GetBuilder<HomeController>(
        init: HomeController(),
          ...
          if(controller.isPortrait == false){
            return settingLandscape(controller: controller, height: height, width: width);
          }else{
            return settingPotrait(controller: controller, height: height, width: width);
          }
  ...
  Widget settingPotrait({required HomeController controller, required double height, required double width}){
    return  Container(
      height: height,
      width: width,
  ...
  Widget settingLandscape({required HomeController controller, required double height, required double width}){
    return
    RotatedBox(
      quarterTurns: 1,
      child: Container(
