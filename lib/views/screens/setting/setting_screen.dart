...
class _SettingScreenState extends State<SettingScreen> {
  ...
  Obx buildSettingsUi(HomeController controller) {
    return Obx(
      () => Column(
        children: [
          JHGHeadWithActions(
            ...
            onTapTitle: () => controller.updateIsExpanded(),
            onArrowDownTap: () => controller.updateIsExpanded(),
            arrowIcon: controller.isExpanded.value
          ...
          Container(
            ...
            child: JHGExpandableSection(
              expand: controller.isExpanded.value,
              child: Visibility(
